...
let leeDescription = '협성대 3학년을 재학중인 학생이다. 협성대 친구들중 가장 "뛰어난 코딩실력"과 "리버싱 및 칼리리눅스를 이용한 뛰어난 해킹 실력" 그리고 "컴퓨터에 대한 엄청난 열정"을 가지고 있다. 나를 포함 2016학번 친구들중 "Hello world!"도 모르면서 문과였고 컴퓨터의 "컴"도 모르지만 컴퓨터 공학과에 들어온 친구들에게 친절하게 A-Z까지 알려주며 코딩실력을 키워주었다.';
...
let lee = new Unit("이유환(Zerg Hero)", 200, 200, 5, leeDescription, './public/images/lee.png');
